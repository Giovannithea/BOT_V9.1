        ...
        for (const ix of instructions) {
            ...
            if (programId === RAYDIUM_AMM_PROGRAM_ID.toString() && ix.data.length > 0) {
                ...
                const indexedAccounts = {
                    ...
                    baseMint: accounts[accountIndices[8]],  // Changed from coinMint
                    quoteMint: accounts[accountIndices[9]], // Changed from pcMint
                    baseVault: accounts[accountIndices[10]], // Changed from coinVault
                    quoteVault: accounts[accountIndices[11]], // Changed from pcVault
                ...
                let tokenData = {
                    ...
                    baseMint: new PublicKey(indexedAccounts.baseMint).toString(), // Changed from coinMint
                    quoteMint: new PublicKey(indexedAccounts.quoteMint).toString(), // Changed from pcMint
                    baseVault: new PublicKey(indexedAccounts.baseVault).toString(), // Changed from coinVault
                    quoteVault: new PublicKey(indexedAccounts.quoteVault).toString(), // Changed from pcVault
                    ...
                    isWSOLSwap: indexedAccounts.baseMint === WSOL_MINT, // Changed from coinMint
                    wrappedSOLAmount: indexedAccounts.baseMint === WSOL_MINT // Changed from coinMint
                        ? params.initCoinAmount
                        : null,
                    fee: "0.003" // Added default fee (0.3%)
                };
